...
<div class="row bg-light">
    <a class="col-lg-3 col-sm-3 col-xl-3" href="../index.php" target="_top"><img style="display:block;margin:auto;" class="img-fluid" src="<?php echo obtenerImagen('logo'); ?>" width="300" height="150"></a>
        ...
        <ul class="menudes navbar-nav">
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown" target="_top"><b>Videojuegos</b></a>
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="./plantillaVideojuegos.php?categoria=PS4" target="_top">Juegos para PS4</a>
                    <a class="dropdown-item" href="./plantillaVideojuegos.php?categoria=XBOX" target="_top">Juegos para XBOX ONE</a>
                    <a class="dropdown-item" href="./plantillaVideojuegos.php?categoria=PC" target="_top">Juegos para PC</a>
                    <a class="dropdown-item" href="./plantillaVideojuegos.php?categoria=PSVITA" target="_top">Juegos para VITA</a>
                    <a class="dropdown-item" href="./plantillaVideojuegos.php?categoria=SWITCH" target="_top">Juegos para SWITCH</a>
                </div>
            </li>
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown" target="_top"><b>Electrónica</b></a>
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="./plantillaAccesorios.php?categoria=ACC_PS4" target="_top">Accesorios PS4</a>
                    <a class="dropdown-item" href="./plantillaAccesorios.php?categoria=ACC_XBOX" target="_top">Accesorios XBOX ONE</a>
                    <a class="dropdown-item" href="./plantillaAccesorios.php?categoria=ACC_VITA" target="_top">Accesorios VITA</a>
                    <a class="dropdown-item" href="./plantillaAccesorios.php?categoria=ACC_SWITCH" target="_top">Accesorios SWITCH</a>
                </div>
            </li>
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown" target="_top"><b>Videoconsolas</b></a>
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="./plantillaConsolas.php?categoria=CON_PS4" target="_top">Videoconsolas PS4</a>
                    <a class="dropdown-item" href="./plantillaConsolas.php?categoria=CON_XBOX" target="_top">Videoconsolas XBOX ONE</a>
                    <a class="dropdown-item" href="./plantillaConsolas.php?categoria=CON_SWITCH" target="_top">Videoconsolas SWITCH</a>
                </div>
            </li>
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown" target="_top"><b>Ofertas</b></a>
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="./plantillaAccesorios.php?tipo=ACCESORIOS" target="_top">Accesorios</a>
                    <a class="dropdown-item" href="./plantillaConsolas.php?tipo=CONSOLAS" target="_top">Videoconsolas</a>
                    <a class="dropdown-item" href="./plantillaMerchandising.php?tipo=MERCHANDISING" target="_top">Merchandising</a>
                    <a class="dropdown-item" href="./plantillaVideojuegos.php?tipo=VIDEOJUEGO" target="_top">Juegos</a>
                </div>
            </li>
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown" target="_top"><b>Merchandising</b></a>
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="./plantillaMerchandising.php?categoria=PELUCHES" target="_top">Peluches</a>
                    <a class="dropdown-item" href="./plantillaMerchandising.php?categoria=ROPA" target="_top">Ropa</a>
                    <a class="dropdown-item" href="./plantillaMerchandising.php?categoria=FIGURAS" target="_top">Figuras</a>
                    <a class="dropdown-item" href="./plantillaMerchandising.php?categoria=OTROS" target="_top">Otros</a>
                </div>
            </li>
            <?php
