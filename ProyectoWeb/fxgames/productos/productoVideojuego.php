...
<?php include "./cabecera.php" ?>
    ...
    <div class="row">  
        ...
        <div class="col-lg-4 col-sm-4 col-xl-4">
            ...
            <p class="parrprod">Fecha de lanzamiento: </p><p><?php echo $resultado['FECHA_LANZAMIENTO']; ?></p>
            <p class="parrprod">Género: </p><p><?php echo $resultado['GENERO']; ?></p>
            <div>
    ...
    <div class="row">
        ...
        <div class="col-lg-5 col-sm-5 col-xl-5" id="#valoracion">               
            <h1>&gt;<a class="text-info" data-toggle="collapse" href="#Mario2">Trailer</a>
            <div class="collapse show" id="Mario2"><br>
                <iframe width="560" height="315" src="<?php echo $resultado['VIDEO']; ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div></h1>
        </div>
    </div><br>
<!--Incluimos footer-->
