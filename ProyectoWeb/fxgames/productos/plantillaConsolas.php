<?php
    ...
    if(isset($_GET['categoria'])){
        ...
        switch($cat){
            case "CON_SWITCH":
                $titulo="Consolas Nintendo Switch";
            break;
            case "CON_PS4":
                $titulo="Consolas PS4";
            break;
            case "CON_XBOX":
                $titulo="Consolas Xbox One";
            break;
        }
    }
    ...
    <div class="row">
      ...
      <div class="row">
            ...
            <div class="collapse" id="Dispo"><br>
                <p><a href="plantillaConsolas.php<?php if(isset($cat)){ echo "?categoria=".$cat."&"; }else{ echo "?";} ?>disponibildad=1&tipo=CONSOLAS">Stock</a></p>
                <p><a href="plantillaConsolas.php<?php if(isset($cat)){ echo "?categoria=".$cat."&"; }else{ echo "?";} ?>disponibildad=0&tipo=CONSOLAS">Reserva</a></p>
            </div></li>
            <p class="col-lg-2 col-sm-2 col-xl-2"></p>
     </div> <br>    
        <div class="row">
    ...
    ?>        
        <div class="col-lg-4 col-sm-4 col-xl-4 imgNS">
                <div class="row">
                    <div class="col-lg-12 col-sm-12 col-xl-12">
                        <p class="col-lg-2 col-sm-2 col-xl-2"></p>
                        <a href="./productoConsola.php?id=<?php echo $fila['ID']; ?>"><img class="img-fluid prod col-lg-8 col-sm-8 col-xl-8" style="display: block;margin: auto;" src="<?php echo obtenerImagen($fila['TITULO']); ?>" width="250" height="200"></a>
                        <p class="col-lg-2 col-sm-2 col-xl-2"></p>
                    </div>
                </div>
                <hr class="linea2">
