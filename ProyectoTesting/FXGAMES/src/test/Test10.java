...
public class Test10 {
	public static void main(String[] args) {
		...
		try {
			...
			traza = "Paso 3 => Se pulsa en la imagen del producto One Piece Burning Blood";
			...
			if (mensaje.equals(videojuego.leerTitulo())) {
				res ="OK";
			...
			if (args.length>0) {
				mc.writeExcelReport(test, res, 10, args[0]);
			}
		} catch (Exception e) {
			...
			if (args.length>0) {
				mc.writeExcelReport(test, "KO", 10, args[0]);
			}
			e.printStackTrace();
		} finally {
			//cerrar el driver
