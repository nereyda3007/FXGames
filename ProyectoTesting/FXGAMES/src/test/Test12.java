...
public class Test12 {
	public static void main(String[] args) {
		...
		String traza = "";
		String mensaje = "Tu cesta está vacía.";
		try {
			// navegar a url
			driver.get(pm.url);
			//Pasos del test
			...
			traza = "Paso 10 => Se introduce un 2 en la opción Cantidad y se pulsa Actualizar";
			cesta.escribirCantidad("2");
			cesta.pulsarActualizar();
			mc.writeReport("INFO", "OK", traza, driver, "Paso 10");
			traza = "Paso 11 => Se pulsa en el botón de la X";
			cesta.pulsarX();
